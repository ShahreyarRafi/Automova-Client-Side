                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                            <div className="relative lg:max-w-md">
                                ...
                                />
                                <div className="absolute bottom-0 right-0 z-10 p-8 bg-[#202020] border-4 border-[#FF9D00] rounded shadow dark:border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800">
                        ...
                        <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0">
                            <div className="pl-4 mb-6 border-l-4 border-[#FF9D00]">
                                ...
                                <h1 className="mt-2 text-3xl font-black text-gray-100 md:text-5xl dark:text-gray-300">
                                    About Us
                                </h1>
                            </div>
                            <p className="mb-6 text-base leading-7 text-gray-100 dark:text-gray-400">
