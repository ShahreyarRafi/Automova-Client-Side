        ...
        <div className='bg-[#eef2fa] dark:bg-[#090b11] duration-300'>
            {porscheProducts.length > 0 ? (
                <div>
                    ...
                    <h2 className='font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-center mb-1 mt-10 text-black dark:text-gray-100 duration-300 font-primary'>Explore Porsches</h2>
