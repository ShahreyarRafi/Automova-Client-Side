...
import image1 from '../../assets/images/bads/b1.jpg';
import image2 from '../../assets/images/bads/b2.jpg';
import image3 from '../../assets/images/bads/b3.jpg';
        ...
        <div className='bg-[#eef2fa] dark:bg-[#090b11] duration-300'>
            {bmwProducts.length > 0 ? (
                <div>
                                ...
                                >
                                    ...
                                    <div className="absolute flex justify-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                                        <div className='flex flex-col items-center justify-center h-[88vh]'>
                                            <h2 className='xl:text-7xl md:text-5xl text-3xl font-rubik font-bold text-white text-center md:leading-[1.2] drop-shadow-lg shadow-black mb-8'><span className='text-[#FF9D00]'>BMW:</span> where style, tech, and performance unite.</h2>
                    ...
                    <h2 className='font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-center mb-1 mt-10 text-black dark:text-gray-100 duration-300 font-primary'>Explore BMWs</h2>
